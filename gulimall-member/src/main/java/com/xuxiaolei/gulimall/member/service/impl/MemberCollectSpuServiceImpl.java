...
import com.xuxiaolei.gulimall.member.dao.MemberCollectSpuDao;
import com.xuxiaolei.gulimall.member.entity.MemberCollectSpuEntity;
import com.xuxiaolei.gulimall.member.service.MemberCollectSpuService;
...
public class MemberCollectSpuServiceImpl extends ServiceImpl<MemberCollectSpuDao, MemberCollectSpuEntity> implements MemberCollectSpuService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<MemberCollectSpuEntity> page = this.page(
                new Query<MemberCollectSpuEntity>(params).getPage(),
