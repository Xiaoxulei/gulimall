...
import com.xuxiaolei.gulimall.coupon.dao.SkuFullReductionDao;
import com.xuxiaolei.gulimall.coupon.entity.SkuFullReductionEntity;
import com.xuxiaolei.gulimall.coupon.service.SkuFullReductionService;
...
public class SkuFullReductionServiceImpl extends ServiceImpl<SkuFullReductionDao, SkuFullReductionEntity> implements SkuFullReductionService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<SkuFullReductionEntity> page = this.page(
                new Query<SkuFullReductionEntity>(params).getPage(),
