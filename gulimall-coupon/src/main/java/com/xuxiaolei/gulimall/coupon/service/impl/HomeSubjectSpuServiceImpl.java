...
import com.xuxiaolei.gulimall.coupon.dao.HomeSubjectSpuDao;
import com.xuxiaolei.gulimall.coupon.entity.HomeSubjectSpuEntity;
import com.xuxiaolei.gulimall.coupon.service.HomeSubjectSpuService;
...
public class HomeSubjectSpuServiceImpl extends ServiceImpl<HomeSubjectSpuDao, HomeSubjectSpuEntity> implements HomeSubjectSpuService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<HomeSubjectSpuEntity> page = this.page(
                new Query<HomeSubjectSpuEntity>(params).getPage(),
