...
import com.xuxiaolei.gulimall.order.dao.OrderOperateHistoryDao;
import com.xuxiaolei.gulimall.order.entity.OrderOperateHistoryEntity;
import com.xuxiaolei.gulimall.order.service.OrderOperateHistoryService;
...
public class OrderOperateHistoryServiceImpl extends ServiceImpl<OrderOperateHistoryDao, OrderOperateHistoryEntity> implements OrderOperateHistoryService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<OrderOperateHistoryEntity> page = this.page(
                new Query<OrderOperateHistoryEntity>(params).getPage(),
