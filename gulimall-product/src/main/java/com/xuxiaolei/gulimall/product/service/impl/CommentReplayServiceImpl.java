...
import com.xuxiaolei.gulimall.product.dao.CommentReplayDao;
import com.xuxiaolei.gulimall.product.entity.CommentReplayEntity;
import com.xuxiaolei.gulimall.product.service.CommentReplayService;
...
public class CommentReplayServiceImpl extends ServiceImpl<CommentReplayDao, CommentReplayEntity> implements CommentReplayService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<CommentReplayEntity> page = this.page(
                new Query<CommentReplayEntity>(params).getPage(),
