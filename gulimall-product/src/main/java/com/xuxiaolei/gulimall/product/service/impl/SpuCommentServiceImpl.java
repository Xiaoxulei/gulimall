...
import com.xuxiaolei.gulimall.product.dao.SpuCommentDao;
import com.xuxiaolei.gulimall.product.entity.SpuCommentEntity;
import com.xuxiaolei.gulimall.product.service.SpuCommentService;
...
public class SpuCommentServiceImpl extends ServiceImpl<SpuCommentDao, SpuCommentEntity> implements SpuCommentService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<SpuCommentEntity> page = this.page(
                new Query<SpuCommentEntity>(params).getPage(),
