...
import com.xuxiaolei.gulimall.product.dao.SpuInfoDao;
import com.xuxiaolei.gulimall.product.entity.SpuInfoEntity;
import com.xuxiaolei.gulimall.product.service.SpuInfoService;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<SpuInfoEntity> page = this.page(
                new Query<SpuInfoEntity>(params).getPage(),
