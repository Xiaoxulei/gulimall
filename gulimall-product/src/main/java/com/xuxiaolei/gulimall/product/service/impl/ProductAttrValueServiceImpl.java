...
import com.xuxiaolei.gulimall.product.dao.ProductAttrValueDao;
import com.xuxiaolei.gulimall.product.entity.ProductAttrValueEntity;
import com.xuxiaolei.gulimall.product.service.ProductAttrValueService;
...
public class ProductAttrValueServiceImpl extends ServiceImpl<ProductAttrValueDao, ProductAttrValueEntity> implements ProductAttrValueService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<ProductAttrValueEntity> page = this.page(
                new Query<ProductAttrValueEntity>(params).getPage(),
