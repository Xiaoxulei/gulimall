...
import com.xuxiaolei.gulimall.product.dao.SkuSaleAttrValueDao;
import com.xuxiaolei.gulimall.product.entity.SkuSaleAttrValueEntity;
import com.xuxiaolei.gulimall.product.service.SkuSaleAttrValueService;
...
public class SkuSaleAttrValueServiceImpl extends ServiceImpl<SkuSaleAttrValueDao, SkuSaleAttrValueEntity> implements SkuSaleAttrValueService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<SkuSaleAttrValueEntity> page = this.page(
                new Query<SkuSaleAttrValueEntity>(params).getPage(),
